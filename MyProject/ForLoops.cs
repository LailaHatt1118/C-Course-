...
// ********************************************** Foreach loop *********************************************************************************************************
      // Foreach loop = a simple way to iterate over an array , but it's less flexible ( you can't increment ou descement with)
      ...
      {
            Console.WriteLine(car);     // it's like for but not flexible
      }
      }
    }
}